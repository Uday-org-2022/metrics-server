...
## Deployment
In order to deploy metrics-server in your kubernetes master machine clone https://github.com/Uday-org-2022/metrics-server.git  and run the following command from
